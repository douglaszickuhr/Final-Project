...
companies_with_pca %>%
  ...
  dplyr::summarise(median_total_complaint = median(total_complaint),
                   max_total_complaint = max(total_complaint),
                   min_total_complaint = min(total_complaint),
                   median_total_solved_complaint = median(total_solved_complaint),
                   median_perc_solved = median(perc_solved),
                   median_total_issue_types = median(total_issues_types),
                   median_weeks_to_solve = median(average_weeks))
